...
public class Controller {
    ...
    private ICollection<TData> collection = new DummyHashTable<TData>(new InternalHashFunction<>(10000));
    ...
    TData collectionFind(TData data) {
        TData ret;
        long time = System.nanoTime();
        ret = collection.find(data);
        time = System.nanoTime() - time;
    ...
    private void reloadTree() {
        treeView.setRoot(collection.convert());
